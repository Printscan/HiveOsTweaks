...
function arcturus_oc(){
    echo 5 > /sys/class/drm/card${cardno}/device/pp_power_profile_mode 2> /dev/null
    echo "manual" > /sys/class/drm/card${cardno}/device/power_dpm_force_performance_level 2> /dev/null
    echo -e "${YELLOW}OC not implemented yet${NOCOLOR}"
}
